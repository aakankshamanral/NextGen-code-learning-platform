...
const LEVELS = [
  ...
  { id: 2, title: "2. Let's Code", status: "completed", x: "100px", mascot: "🤖", msg: "Code your first program" },
  { id: 3, title: "3. Functions", status: "current", x: "-100px", mascot: "🐼", msg: "Almost there!" },
  { id: 4, title: "4. Arrays", status: "locked", x: "100px", mascot: "🦁", msg: "You can do it bud!" },
  ...
  return (
    <div className="min-h-screen bg-[#0b0e14] text-white flex overflow-hidden relative font-sans">
      ...
      <div className="absolute top-0 left-0 right-0 z-30 px-10 py-8 flex items-center justify-between pointer-events-none">
        ...
        <div className="flex items-center gap-3 bg-[#161b22]/80 backdrop-blur-md p-1.5 pr-5 rounded-full border border-gray-800 shadow-xl pointer-events-auto cursor-pointer hover:border-cyan-500/50 transition-all">
